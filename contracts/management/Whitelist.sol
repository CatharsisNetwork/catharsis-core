 ...
 */
contract Whitelist is SystemRoles {
     ...
     */
    function addAddressesToWhitelist(address[] memory addrs) public returns (bool success) {
     ...
     */
    function removeAddressesFromWhitelist(address[] memory addrs) public returns (bool success) {
        for (uint256 i = 0; i < addrs.length; i++) {
